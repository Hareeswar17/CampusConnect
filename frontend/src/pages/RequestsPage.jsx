...
const SAMPLE_INCOMING = [
  {
    ...
    detail: "Biology Major · Junior",
    tags: ["Common Classes: BIO 301", "CHEM 205"],
  ...
  },
  {
    ...
    detail: "Computer Science Major · Sophomore",
    tags: ["Interests: Study Groups", "Coding"],
    profilePic: "/avatar.png",
    timeLabel: "1d ago",
  },
];
...
const SAMPLE_OUTGOING = [
  {
    ...
    detail: "Literature Major · Senior",
    profilePic: "/avatar.png",
  },
  {
    _id: "preview-out-2",
    fullName: "David Thompson",
    detail: "Physics Major · Freshman",
    profilePic: "/avatar.png",
  },
];
...
function RequestsPage() {
  ...
  const { incoming, outgoing, previewMode } = useMemo(() => {
    ...
    const normalizedOutgoing = hasOutgoing
    ...
    return {
      ...
      previewMode: !hasIncoming && !hasOutgoing,
    };
                ...
                >
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3">
                    <button
                      ...
                      disabled={
                        previewMode || request._id.startsWith("preview-")
                      }
            ...
            <section className="space-y-4">
              ...
              {outgoing.map((request) => (
                ...
                >
                  ...
                  <button
                    type="button"
                    disabled={previewMode || request._id.startsWith("preview-")}
